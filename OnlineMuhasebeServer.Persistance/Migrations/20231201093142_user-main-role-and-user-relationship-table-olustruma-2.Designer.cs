...
namespace OnlineMuhasebeServer.Persistance.Migrations
{
    ...
    [Migration("20231201093142_user-main-role-and-user-relationship-table-olustruma-2")]
    partial class usermainroleanduserrelationshiptableolustruma2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineMuhasebeServer.Domain.AppEntities.Company", b =>
                {
                    ...
                    b.Property<string>("IdentitiyNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineMuhasebeServer.Domain.AppEntities.MainRoleAndRoleRelationship", b =>
                {
                    ...
                    b.ToTable("MainRoleAndRoleRelationship");
                });
