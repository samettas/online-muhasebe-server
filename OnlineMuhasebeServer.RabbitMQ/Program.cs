...
internal class Program
{
    ...
    {
        string reportsString = Encoding.UTF8.GetString(e.Body.ToArray());
        ReportDto reportDto = JsonConvert.DeserializeObject<ReportDto>(reportsString);
    ...
    public static void CreateUCAFExcel(ReportDto reportDto)
    {
        ...
        using (var workbook = new XLWorkbook())
        {
            ...
            string filePath = $"C:/Users/samet/source/repos/samettas/online-muhasebe-server/OnlineMuhasebeClient/src/assets/reports/{fileName}";
